...
namespace ThunderKit.Addressable.Tools
{
    ...
    public class AddressableObjectSelector : TemplatedWindow
    {
        private static bool IsTemplatePath(string path) => path.Contains("Packages/com.kevinfromhp.addressablematerials");
        ...
        private void InitializeBrowser(object sender = null, EventArgs e = null)
        {
            ...
            GetTemplateInstance(GetType().Name, rootVisualElement, IsTemplatePath);
            ...
            directoryContent.onItemChosen += Directory_OnItemChosen;
#if UNITY_2019_1_OR_NEWER
        ...
        private void Directory_OnItemChosen(object obj)
        {
            onItemChosen(obj);
            this.Close();
        }
